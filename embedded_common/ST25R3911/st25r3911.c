...
void st25r3911PowerDown( void )
{
	st25r3911WriteRegister(ST25R3911_REG_IO_CONF1, ST25R3911_REG_IO_CONF1_lf_clk_off | ST25R3911_REG_IO_CONF1_out_cl0 | ST25R3911_REG_IO_CONF1_out_cl1 | ST25R3911_REG_IO_CONF1_osc);
	st25r3911WriteRegister(ST25R3911_REG_IO_CONF2, ST25R3911_REG_IO_CONF2_sup3V);
	st25r3911WriteRegister(ST25R3911_REG_OP_CONTROL, 0x00); // Power-down mode
...
void st25r3911ClearRSSI(uint8_t* result)
{
    st25r3911ExecuteCommandAndGetResult(ST25R3911_CMD_CLEAR_RSSI,
                                    ST25R3911_REG_AD_RESULT,
                                    10,
                                    result);
}

void st25r3911GetRSSI(uint8_t* result)
{
	st25r3911ReadRegister(ST25R3911_REG_RSSI_RESULT, result);
}
