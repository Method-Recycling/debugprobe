...
ReturnCode rfalMeasureCapacitance( uint8_t* result )
{
...
ReturnCode rfalMeasureAntennaResonance( uint8_t* result )
{
	st25r3911MeasureAntennaResonance( result );

	return ERR_NONE;
}

ReturnCode rfalClearRSSI( uint8_t* result )
{
	st25r3911ClearRSSI( result );

	return ERR_NONE;
}

ReturnCode rfalGetRSSI( uint8_t* result )
{
	st25r3911GetRSSI( result );
